...
/**
 * An implementation class for "less than or equal" in-memory filter.
 * 
 * @author higa
 * @since 1.0.1
 * 
 */
public class InMemoryLessThanOrEqualCriterion extends AbstractCriterion
        implements InMemoryFilterCriterion {
     ...
     */
    public InMemoryLessThanOrEqualCriterion(
