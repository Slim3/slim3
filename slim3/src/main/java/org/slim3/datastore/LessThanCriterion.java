...
/**
 * An implementation class for "less than" filter.
 * 
 * @author higa
 * @since 1.0.0
 * 
 */
public class LessThanCriterion extends AbstractFilterCriterion {
     ...
     */
    public LessThanCriterion(AttributeMeta<?, ?> attributeMeta, Object value)
            throws NullPointerException {
        super(attributeMeta);
