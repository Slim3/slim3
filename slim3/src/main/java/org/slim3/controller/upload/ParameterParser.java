...
public class ParameterParser {
     ...
     */
    protected boolean lowerCaseNames = false;
     ...
     * @return the token
     */
    protected String getToken(boolean quoted) {
     ...
     */
    protected boolean isOneOf(char ch, final char[] charray) {
     ...
     * @return the token
     */
    protected String parseToken(final char[] terminators) {
        char ch;
        i1 = pos;
        i2 = pos;
        while (hasChar()) {
     ...
     * @return the token
     */
    protected String parseQuotedToken(final char[] terminators) {
        char ch;
        i1 = pos;
        i2 = pos;
