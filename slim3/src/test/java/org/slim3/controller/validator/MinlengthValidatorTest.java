...
public class MinlengthValidatorTest {
    ...
    private MinlengthValidator validator = new MinlengthValidator(3);
    ...
    public void validateForInvalidValue() throws Exception {
        ...
        assertThat(
            ...
            is("Aaa can not be less than 3 characters."));
    }
    ...
    public void validateForInvalidValueAndSpecificMessage() throws Exception {
        parameters.put("aaa", "xx");
        assertThat(new MinlengthValidator(3, "hoge")
    ...
    public void getMessageKey() throws Exception {
        assertThat(validator.getMessageKey(), is("validator.minlength"));
    }
}