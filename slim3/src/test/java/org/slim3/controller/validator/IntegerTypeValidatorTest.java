...
public class IntegerTypeValidatorTest {
    ...
    public void validateForNull() throws Exception {
        assertThat(
            IntegerTypeValidator.INSTANCE.validate(parameters, "aaa"),
            is(nullValue()));
    }
    ...
    public void validateForInvalidValueAndSpecificMessage() throws Exception {
        parameters.put("aaa", "xxx");
        assertThat(
            new IntegerTypeValidator("hoge").validate(parameters, "aaa"),
            is("hoge"));
    }
    ...
    public void getMessageKey() throws Exception {
        assertThat(
            IntegerTypeValidator.INSTANCE.getMessageKey(),
            is("validator.integerType"));
    }
}