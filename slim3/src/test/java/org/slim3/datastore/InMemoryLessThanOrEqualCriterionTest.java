 ...
 * 
 */
public class InMemoryLessThanOrEqualCriterionTest extends AppEngineTestCase {
    ...
    public void constructor() throws Exception {
        InMemoryLessThanOrEqualCriterion c =
            new InMemoryLessThanOrEqualCriterion(meta.myString, "aaa");
    ...
    public void accept() throws Exception {
        ...
        hoge.setMyString("c");
        InMemoryLessThanOrEqualCriterion c =
            new InMemoryLessThanOrEqualCriterion(meta.myString, "b");
    ...
    public void acceptForNull() throws Exception {
        ...
        hoge.setMyString("c");
        InMemoryLessThanOrEqualCriterion c =
            new InMemoryLessThanOrEqualCriterion(meta.myString, null);
        assertThat(c.accept(hoge), is(false));
    ...
    public void acceptForCollection() throws Exception {
        Hoge hoge = new Hoge();
        InMemoryLessThanOrEqualCriterion c =
            new InMemoryLessThanOrEqualCriterion(meta.myIntegerList, 1);
