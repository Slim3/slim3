 ...
 * 
 */
public class IsNullCriterionTest extends DatastoreTestCase {
    ...
    public void testApply() throws Exception {
        ...
        IsNullCriterion c = new IsNullCriterion(meta.myString);
        c.apply(query);
    ...
    public void testAccept() throws Exception {
        ...
        FilterCriterion c = new IsNullCriterion(meta.myString);
