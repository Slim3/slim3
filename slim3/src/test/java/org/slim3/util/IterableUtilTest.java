...
public class IterableUtilTest {
    ...
    public void splitWithMod() throws Exception {
        ...
        assertThat((List) ret.get(0), is(Arrays.asList("1", "2")));
        assertThat((List) ret.get(1), is(Arrays.asList("3", "4")));
        assertThat((List) ret.get(2), is(Arrays.asList("5", "6")));
        assertThat((List) ret.get(3), is(Arrays.asList("7")));
    }
