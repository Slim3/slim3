...
public class GenerateSupport {
	 ...
	 *            the processing environment
	 */
	public GenerateSupport(AnnotationProcessorEnvironment processingEnv) {
	...
	public void generate(Generator generator, ClassDesc classDesc,
		...
		com.sun.mirror.apt.Filer filer = processingEnv.getFiler();
		Printer printer = null;
		try {
			printer = createPrinter(filer.createSourceFile(classDesc
					.getQualifiedName()));
